...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID ||
      ...
      alert("Internal Error Occurred. Missing credentials.");
      console.error('EmailJS credentials missing. Check environment variables.');
      return;
    }
  ...
  return (
    <section id='contact' className="relative min-h-screen flex items-center justify-center bg-gradient-to-bl from-black via-gray-900 to-gray-800 overflow-hidden px-6 py-24">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-gray-900/70 backdrop-blur-lg p-8 rounded-2xl shadow-lg flex flex-col gap-6 border border-cyan-500">
          <motion.form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <motion.button
              type="submit"
              disabled={isSending}
              className={`w-full py-3 rounded-lg text-white font-bold bg-gradient-to-r from-pink-500 via-purple-900 to-cyan-500 shadow-lg transition-all ${
